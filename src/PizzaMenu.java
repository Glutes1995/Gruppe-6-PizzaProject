...
public class PizzaMenu {
    ...
    public void addPizzaMenu(PizzaMenu pizzaMenu) {
        ...
        pizzaMenu.addPizza("4 cheeses",100, 17,"Tomato sauce, Cheese,");
        pizzaMenu.addPizza("Trouble truffel",100, 18,"Tomato sauce, Cheese,");
        ...
        pizzaMenu.addPizza("Veggie",100, 21,"Tomato sauce, Cheese,");
        pizzaMenu.addPizza("Vegan special",100, 22,"Tomato sauce, Cheese,");
        pizzaMenu.addPizza("Vegan tropical",100, 23,"Tomato sauce, Cheese,");
        pizzaMenu.addPizza("Gluten free",100, 24,"Tomato sauce, Cheese,");
        ...
        pizzaMenu.addPizza("The indian",100, 30,"Tomato sauce, Cheese,");
        pizzaMenu.addPizza("Manhatten",100, 31,"Tomato sauce, Cheese,");
    }
